...
struct AnnouncementList: Codable {
    ...
    let picList: [JSONAny]
    let picTotal, timezone: Int
    let picTypeList: [JSONAny]
    let banner: String
    let alert: Bool
    let typeList: [TypeList]
    let list: [WelcomeList]
    let picAlertID: Int
...
struct ListList: Codable {
    let title: String
    let loginAlert, remind, remindVer: Int
...
enum TagEndTime: String, Codable {
...
enum TagStartTime: String, Codable {
