        ...
        var body: some View {
            VStack {
                ...
                Text("wizard.license.description")
                    ...
                    .padding(.bottom)
                Form {
                    PolicyTile(name: "wizard.license.typeUser", url: "https://bluedream.icu")
                    PolicyTile(name: "wizard.license.typeInfoCollection", url: "https://bluedream.icu")
                    PolicyTile(name: "wizard.license.typeOpenSource", url: "https://bluedream.icu")
                    PolicyTile(name: "wizard.license.typeIssue", url: "https://bluedream.icu")
                }.formStyle(.grouped)
                Spacer()
