...
extension URLRequest {
    ...
    mutating func setDeviceInfoHeaders() {
        self.setValue(UserDefaults.configGetConfig(forKey: TBConfigKeys.DEVICE_FP, def: ""), forHTTPHeaderField: "x-rpc-device_fp")
        self.setValue("iPhone15,1", forHTTPHeaderField: "x-rpc-device_name")
        self.setValue(UserDefaults.configGetConfig(forKey: TBConfigKeys.DEVICE_ID, def: ""), forHTTPHeaderField: "x-rpc-device_id")
...
//    }
    ...
    /// 设置UA
    mutating func setUA() {
        self.setValue(TBConfigKeys.hoyoUA, forHTTPHeaderField: "User-Agent")
    }
    
    mutating func setIosUA() {
        self.setValue(TBConfigKeys.iosHoyoUA, forHTTPHeaderField: "User-Agent")
    }
    ...
    mutating func setXRPCAppInfo(appID: String = "bll8iq97cem8", client: String = "2") {
        ...
        self.setValue(TBConfigKeys.xrpcVersion, forHTTPHeaderField: "x-rpc-app_version")
    }
